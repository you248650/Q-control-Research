DRL(ngrc) ：卒業研究「深層強化学習を適用した量子コンピュータの制御パルス最適化システム」の学習サイクルの前段階に次世代リザーバーコンピューティングを適用し、学習効率の向上を確認。忠実度を実用レベル99.5%以上維持した状態で、Q-CTRL社の先行論文28.4nsから本コードでは24nsまで短縮することに成功した。また28nsに到達するのに、従来の学習サイクルを1/5まで短縮することができた。
